function showHideNavbarMenuFunction() {
  var showHideNavbarMenu = document.getElementById("nav");
  if (showHideNavbarMenu.className === "nav") {
    showHideNavbarMenu.className += " responsive";
  } else {
    showHideNavbarMenu.className = "nav";
  }
}
